...
project_folder = '/content/drive/My Drive/Colab Notebooks/ARCHER2_RUNS/results/Connecting/SDF' # working folder path
...
predicted_vx100 = predictions2[0][index,:,:,0]
predicted_vy100 = predictions2[1][index,:,:,0]
predicted_rho100 = predictions2[2][index,:,:,0]
