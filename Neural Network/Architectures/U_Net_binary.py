...
# Save predictions
np.save('test_scores3.npy',test_scores)
predictions = model.predict(Input_test)
np.save('predictions3.npy', predictions)
np.save('Vx_test3.npy', Vx_test)
np.save('Vy_test3.npy', Vy_test)
np.save('Rho_test3.npy', Rho_test)
...
np.savez('training_history_data3.npz',
         epochs=epochs,
         loss=loss,
         val_loss=val_loss,
