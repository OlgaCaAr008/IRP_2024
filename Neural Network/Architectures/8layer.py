...
Original file is located at
    https://colab.research.google.com/drive/1qx-Y23nLxUQShR6mvHrQmUByNZerNQIZ
"""
...
np.save('train_loss8.npy', train_loss)
np.save('val_loss8.npy', val_loss)
np.save('test_loss8.npy', test_loss[0])

stopped_epoch = early_stopping.stopped_epoch
print("Training was stopped at epoch - 8:", stopped_epoch)