...
# Save predictions
np.save('test_scores_w2.npy',test_loss)

np.save('predictions_w2.npy', predictions)
np.save('Vx_test_w2.npy', Vx_test)
np.save('Vy_test_w2.npy', Vy_test)
np.save('Rho_test_w2.npy', Rho_test)
